...
int16_t LR11x0::setBandwidth(float bw, bool high) {
  ...
  switch (bw_div2)  {
    ...
    case 31: // 62.5
      ...
      break;
    case 41: // 83.34 ?
      this->bandwidth = RADIOLIB_LR11X0_LORA_BW_83_34;
      break;       
    case 62: // 125.0
    ...
    case 250: // 500.0
      ...
      break;    
    case 500: // 1000.0 ?
      this->bandwidth = RADIOLIB_LR11X0_LORA_BW_1000_0;
      break;   
    default:
      if (high) {
        if(fabsf(bw - 101.5625f) <= 0.001f) {
          this->bandwidth = RADIOLIB_LR11X0_LORA_BW_101_5625; //?
        } else if(fabsf(bw - 203.125f) <= 0.001f) {
