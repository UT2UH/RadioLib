...
// NRST pin:  3
// BUSY pin:  9
LR1121 radio = new Module(10, 2, 3, 9);
...
*/
    ...
    // set RF switch configuration for StingBee TrueD
    // It uses DIO5, DIO6 and DIO8 for RF switching
    // NOTE: other modeles may be different!
...
void setup() {
  ...
  radio.XTAL = false;
  int state = radio.begin(434.0, 125.0, 9, 7, RADIOLIB_LR11X0_LORA_SYNC_WORD_PRIVATE, 10, 8, 3.0);
